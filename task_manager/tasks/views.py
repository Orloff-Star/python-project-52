...
class TaskListView(CheckAuthorizationView, ListView):
    model = Task
...
class TaskDetailView(CheckAuthorizationView, DetailView):
    model = Task
    template_name = 'tasks/task_detail.html'
    context_object_name = 'tasks_detail'


class TaskCreateView(CheckAuthorizationView, SuccessMessageMixin, CreateView):
    model = Task
    form_class = TaskForm
    template_name = 'tasks/task_create.html'
    success_url = reverse_lazy('task_list')
    success_message = _('The task has been created successfully.')
...
class TaskUpdateView(CheckAuthorizationView, SuccessMessageMixin, UpdateView):
    model = Task
    form_class = TaskForm

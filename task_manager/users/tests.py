...
class UserCRUDTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(first_name='Ivanov', last_name='Ivan', username='testuser', password='testpassword123')
        self.client.login(first_name='Ivanov', last_name='Ivan', username='testuser', password='testpassword123')
